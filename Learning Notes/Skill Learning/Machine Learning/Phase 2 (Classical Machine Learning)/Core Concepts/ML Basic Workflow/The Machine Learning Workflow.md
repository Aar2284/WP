...
| [[Sub‑stages of “Data” 🧩#2. Exploratory Data Analysis (EDA)\|2. Exploratory Data Analysis]] | Profile distributions, correlations, missingness, outliers, duplicates.                                          | Skipping visual checks; trusting summary stats blindly.                            |
| [[Sub‑stages of “Data” 🧩#3. Data Cleaning\|3. Cleaning]]                                    | Handle missing values (impute, flag, delete), correct typos, remove duplicates, fix inconsistent units.          | Deleting too much; introducing future information.                                 |
| [[Sub‑stages of “Data” 🧩#4. Data Splitting (Train / Validation / Test)\|4. Splitting]]      | Partition into **train / validation / test** sets (e.g., 70/15/15) while respecting temporal or group structure. | Random split when data is time‑series; data leakage from validation into training. |
